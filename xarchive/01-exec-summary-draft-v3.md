...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Identify new technology and industry trends**  | Identified in 2015 that hyperscalers had moved the network's control point into the host. Designed an elephant-flow balancer in 2017 for the problem the industry took up in 2024 as SRv6-for-AI. Called the SONiC inflection in 2023. In 2021 recognized Cilium/eBPF as a disruptive technology at a strategic control point in the network and advocated Cisco acquire Isovalent. |
...
**Bruce is deeply customer-facing, and he counts time with customers among the most rewarding parts of the job.** He is also a force multiplier: he transfers ideas, knowledge, experience, and tools — labs, code, reference architectures — to account systems engineers, who often carry them to wins entirely without him in the room. The **$17M Meta backbone re-entry** is the clearest case of that second mode — Bruce pioneered the SL-API technique at Microsoft, taught it to the Meta account team, built the labs they validated it in, and never presented to Meta himself.
// this is nice, but we don't need to be so heavy-handed when making the point. I love working with customers, but my force-multiplier empowerment of account teams sometimes mean I'm not in the room when they've gone an won a deal or a franchise
...
3. **Unified Policy and Identity.** Identity and segmentation are just as fragmented as transport: ISE, TrustSec, SASE, and SD-WAN each carry their own version, with no shared path to the forwarding layer. Bruce recognized that a Security Group Tag and an SRv6 uSID are both 16 bits, and co-founded the **Secure Network Policy Framework (SNPF)** tiger team to carry a single identity-and-policy model on top of UFA's forwarding plane. The ISE organization committed to it in December 2025.
...
Pushing these rocks required building relationships with business entities, and with sales DSE and PSE peers outside Bruce's traditional circles within ASP/Web and MIG (Mass-Scale Infrastructure Group). He created the vision behind each rock, filed IPR, and founded or co-founded the tiger team that carries it forward. He did not have a DSE title when he started any of them; he assumed the scope and the authority a DSE is expected to carry, and built the coalition to make it real. That is, in the end, the case this package is making — argued from a decade spent deeply enmeshed in the architectures actually driving the industry, which is why he has been early and right often enough that people who do not report to him keep asking what he thinks.
// I made a couple subtle changes to the above paragraph, but its still clunky. Similar to my earlier comment about being heavy-handed, we don't need to literally explain "he assumed the role of DSE". I think we can use more general phrasing like 'he took the initiative', 'collaborated with peers and built a team', etc.
...
Bruce McDougall was a network operator before he was the Solutions Engineer. As a network engineer at the Expedia Group he was evaluating MPLS in the data centre in 2006, hunting for scale beyond the enterprise tooling of the era. That origin still governs how he chooses what to work on: he asks what he would want if he were still the operator — the simplest, most cost-effective, most extensible, longest-lasting architecture — and what would sustain a healthy industry ecosystem. **Only then does he ask how Cisco gets to the centre of that future.** The order is the discipline, and it is why he is so credible with the most technologically sophisticated customers in the world.
...
// i deleted the SDWAN patent claim, because I was lead author and filed that one. SDWAN engineering filed patent 12009998 with me listed on the patent, so if you like we can put that one in
...
// i thought i asked to delete this paragraph as it just sounds like excuse-making. maybe i asked that of the agent
...
// todo - update all revenue numbers after business impact document edits
...
// this is another heavy-handed or defensive statement: "He does not claim the revenue"...maybe something like "Cisco's Web sales team has grown revenue enormously in recent years and Bruce was instrumental in building the foundations that made that possible"
...
// why do we say "stated plainly"? This paragraph seems to be about how "the revenue numbers are great, but they could be a lot greater if we execute on our silicon timelines", right?
...
// this is nonsensical: "from operator empathy rather than product strategy". My inventions begin from mental connections I make or insights i come to that others haven't
...
// I think we can delete this paragraph
...
- **Programmes with lasting impact** — ASP Lightning Talks, co-created with DSE John Mullooly, at Episode 23 after five years; the GitHub-first Cisco Live lab model, now common practice
