...
Bruce's innovation record starts from an unusual place for a vendor architect: **he was the operator first.** As a network engineer at the Expedia Group (2004–2007) he was hunting for scaling methods beyond the enterprise tooling of the era — which is why he was running MPLS in the data centre in 2006, years before that was a normal thing to do.

That origin still governs how he chooses what to work on. The question he asks is not how Cisco sells more. It is what he would want if he were still the operator: the simplest, most cost-effective, longest-lasting architecture available. And past the individual operator, the ecosystem — because a healthy ecosystem is what produces durable growth for everyone in it, Cisco included. As he puts it, Cisco's customers do not think of themselves as customers; they think of themselves as network operators, and operators choose the technologies that make their own organizations successful. Roads have no value unless they are used, and they should be easy to use.

The consequence is that he is frequently ahead of Cisco, ahead of mainstream customers, and occasionally ahead of the hyperscalers. He is then persistent about it — evangelizing internally and with operators for as long as it takes, and building the labs, prototypes, emulators, and specifications that turn an argument into something a skeptical business entity can evaluate and a customer can run.
...
Bruce holds **6 patents**, with **9 patents pending** and **1 defensive publication**. Almost all of them are applied SRv6.

Those grants and filings come out of **36 invention disclosures** submitted over his Cisco career, **24 of them since becoming a Principal Systems Engineer in August 2020** — a submission rate Brook Crossman characterized in the 1HFY26 assessment as **"on pace to break (ASP) records."** The pending filings include **5 continuations on the SmartTOR / NIC-based segment routing family**, a pattern that signals Cisco building protection around the invention rather than filing once and moving on.
...
> **`[verify]`** — Counts above are Bruce's (6 patents / 9 pending / 1 defensive publication). The filing tables below carry no issue dates, so they cannot corroborate the granted-versus-pending split on their own. Attach CPOL portal links, and confirm each of the 6 grants before the package goes out — per prior package guidance, a filing must not be described as an issued patent until confirmed.
