...
| **O'Reilly — *Build Your Own Networking Lab*** (co-developed with Russ White, Akamai) | 2024–2025          | Four-hour live event delivered live twice; materials at [github.com/brmcdoug/open-source-labbing](https://github.com/brmcdoug/open-source-labbing). Co-authorship with one of the industry's most recognized networking authors → **Industry Impact** |
